const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Nav */
  .nav { position: fixed; top: 0; left: 0; right: 0; z-index: 200; background: rgba(247,249,252,0.85); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border-bottom: 1px solid var(--border); padding: env(safe-area-inset-top, 0px) 2rem 0; display: flex; align-items: center; justify-content: space-between; height: calc(44px + env(safe-area-inset-top, 0px)); transform: translateY(0); transition: transform 0.28s cubic-bezier(0.4,0,0.2,1); will-change: transform; }
  ...
  .ptr-indicator { position:fixed; top:calc(env(safe-area-inset-top,0px) + 12px); left:50%; transform:translateX(-50%); width:28px; height:28px; z-index:0; pointer-events:none; opacity:0; transition:opacity 0.18s ease; }
  ...
  @media (max-width: 768px) {
    ...
    .dashboard { padding-top:0.375rem; padding-left:1.25rem; padding-right:1.25rem; }
    .collector-dashboard { padding-top:0.375rem; padding-left:1.25rem; padding-right:1.25rem; }
    .artist-page { padding-top:0.375rem; padding-left:1.25rem; padding-right:1.25rem; }
  ...
  .sort-tab { font-size:0.78rem; font-weight:600; padding:0.4rem 0.9rem; border-radius:100px; border:1.5px solid var(--border); background:white; color:var(--slate); cursor:pointer; transition:all 0.15s; font-family:var(--font-body); flex-shrink:0; white-space:nowrap; }
  ...
  @media (max-width: 768px) {
    .feed-page { padding-top:0.375rem; padding-left:1.25rem; padding-right:1.25rem; }
  ...
  .feed-filter-row { display:flex; align-items:center; gap:0.75rem; overflow-x:auto; flex-wrap:nowrap; -webkit-overflow-scrolling:touch; scrollbar-width:none; padding-bottom:2px; width:100%; min-width:0; }
  .feed-filter-row::-webkit-scrollbar { display:none; }
  .feed-filter-label { font-size:0.75rem; font-weight:600; color:var(--slate); flex-shrink:0; white-space:nowrap; }
  .feed-filter-input { width:90px; flex-shrink:0; padding:0.5rem 0.75rem; border:1.5px solid var(--border); border-radius:var(--radius); font-family:var(--font-body); font-size:0.85rem; color:var(--ink); background:white; transition:border-color 0.2s; }
  ...
  @media (max-width:768px) {
    .artist-browse-page { padding-top:0.375rem; padding-left:1.25rem; padding-right:1.25rem; }
  ...
  .search-image-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:3px; margin:0 -2rem; }
  .search-image-cell { aspect-ratio:1/1; overflow:hidden; cursor:pointer; background:var(--parchment); position:relative; }
  .search-image-cell img { width:100%; height:100%; object-fit:cover; display:block; transition:transform 0.2s; }
  .search-image-cell:hover img { transform:scale(1.04); }
